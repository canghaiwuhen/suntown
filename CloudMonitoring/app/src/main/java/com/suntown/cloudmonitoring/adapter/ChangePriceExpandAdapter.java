 ...
 */
public class ChangePriceExpandAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<Item0> items;
    private Map<String,List<RegisterMor.RECORDBean>> listMap;
    public ChangePriceExpandAdapter(Context context, List<Item0> items, Map<String, List<RegisterMor.RECORDBean>> listMap) {
