package com.suntown.cloudmonitoring.receiver;
...
import com.suntown.cloudmonitoring.activity.MainActivity;
import com.suntown.cloudmonitoring.activity.MessageActivity;
...
public class MyReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
			...
			//打开自定义的Activity
			String username = SPUtils.getString(context, Constant.USER_NAME);
