...
import com.suntown.cloudmonitoring.adapter.AlbumListAdapter;
import com.suntown.cloudmonitoring.base.BaseActivity;
import com.suntown.cloudmonitoring.base.BaseApplication;
import com.suntown.cloudmonitoring.chatting.entity.ImageBean;
import com.suntown.cloudmonitoring.utils.Constant;
import com.suntown.cloudmonitoring.utils.SortPictureList;
...
//	private ImageButton mMenuBtn;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		name = mIntent.getStringExtra(Constant.NAME);
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				startActivityForResult(mIntent, BaseApplication.REQUEST_CODE_SELECT_ALBUM);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == BaseApplication.RESULT_CODE_SELECT_ALBUM) {
			setResult(BaseApplication.RESULT_CODE_SELECT_PICTURE, data);
			finish();
		}
	}
