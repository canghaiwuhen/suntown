...
import com.suntown.cloudmonitoring.activity.form.BrowserViewPagerActivity;
import com.suntown.cloudmonitoring.adapter.PickPictureAdapter;
...
import com.suntown.cloudmonitoring.chatting.utils.HandleResponseCode;
...
public class PickPictureActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTargetAppKey = intent.getStringExtra(BaseApplication.TARGET_APP_KEY);
    ...
    private OnItemClickListener onItemListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> viewAdapter, View view, int position, long id) {
            ...
            intent.putExtra(BaseApplication.POSITION, position);
            ...
            startActivityForResult(intent, BaseApplication.REQUEST_CODE_BROWSER_PICTURE);
        }
    };
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == BaseApplication.RESULT_CODE_SELECT_PICTURE) {
            if (data != null) {
        ...
        } else if (resultCode == BaseApplication.RESULT_CODE_BROWSER_PICTURE) {
            setResult(BaseApplication.RESULT_CODE_SELECT_ALBUM, data);
            finish();
        }
    }
            ...
            if (activity != null) {
                switch (msg.what) {
                    case SEND_PICTURE:
                        ...
                        activity.setResult(BaseApplication.RESULT_CODE_SELECT_ALBUM, intent);
