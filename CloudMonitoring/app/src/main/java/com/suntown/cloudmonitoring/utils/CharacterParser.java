...
public class CharacterParser {
	...
	public List<SortModel> filledData(List<String> date){
...
//		Collections.sort(mSortList, (o1, o2) -> 0);
		return mSortList;
	}
//	public List<SortModel> filledData1(List<ShopInfo> data) {
//		List<SortModel> mSortList = new ArrayList<SortModel>();
//		for (ShopInfo shopInfo : data) {
//			SortModel sortModel = new SortModel();
//			sortModel.setName(shopInfo.SNAME);
//			//汉字转换成拼音
//			String pinyin = characterParser.getSelling(shopInfo.SNAME);
//			String sortString = pinyin.substring(0, 1).toUpperCase();
//
//			// 正则表达式，判断首字母是否是英文字母
//			if(sortString.matches("[A-Z]")){
