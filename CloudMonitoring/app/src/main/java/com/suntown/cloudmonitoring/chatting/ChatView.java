...
public class ChatView extends RelativeLayout {
	...
	public void initModule(float density, int densityDpi) {
        ...
        mChatListView = (DropDownListView) findViewById(R.id.jmui_chat_list);
        mVoiceBtn = (RecordVoiceButton) findViewById(R.id.jmui_voice_btn);
        mChatInputEt = (EditText) findViewById(R.id.jmui_chat_input_et);
        mSwitchIb = (ImageButton) findViewById(R.id.jmui_switch_voice_ib);
        mAddFileIb = (ImageButton) findViewById(R.id.jmui_add_file_btn);
        ...
        mBackground = (LinearLayout) findViewById(R.id.jmui_chat_background);
        ...
        mExpressionIb = (ImageButton) findViewById(R.id.jmui_expression_btn);
        mLocationIb = (ImageButton) findViewById(R.id.jmui_send_location_btn);
        mSendFileIb = (ImageButton) findViewById(R.id.jmui_send_file_btn);
        ...
        mChatInputEt.setOnEditorActionListener((v, actionId, event) -> {
    ...
    OnFocusChangeListener listener = (v, hasFocus) -> {
        if (hasFocus) {
            Log.i("ChatView", "Input focus");
            Handler handler = new Handler();
            handler.post(() -> dismissMoreMenu());
        }
    };
