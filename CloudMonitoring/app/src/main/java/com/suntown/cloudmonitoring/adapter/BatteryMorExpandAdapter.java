 ...
 */
public class BatteryMorExpandAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<Item0> items;
    private Map<String,List<RegisterMor.RECORDBean>> listMap;
    public BatteryMorExpandAdapter(Context context, List<Item0> items, Map<String, List<RegisterMor.RECORDBean>> listMap) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        tvStoreNum.setText(recordBeanList.size()+"");
