...
public class CartItemDetialAdapter extends BaseAdapter{
    Context context;
    List<String> stringList;
    Map<String, List<APInfoBean.RECORDBean>> listMap;
    int intExtra;

    public CartItemDetialAdapter(Context context, List<String> stringList, Map<String, List<APInfoBean.RECORDBean>> listMap,int intExtra) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        viewHolder.tvTag.setText(recordBean.SNAME+s1+":");
