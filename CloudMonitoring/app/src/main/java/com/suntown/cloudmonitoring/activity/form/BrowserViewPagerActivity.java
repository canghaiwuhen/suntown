...
import com.suntown.cloudmonitoring.chatting.photoview.PhotoView;
...
import com.suntown.cloudmonitoring.utils.NativeImageLoader;
import com.suntown.cloudmonitoring.weight.ImgBrowserViewPager;
...
public class BrowserViewPagerActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (groupId != 0) {
            ...
            String targetId = intent.getStringExtra(Constant.NAME);
            if (targetId != null) {
    ...
    private void checkPictureSelected(final int currentItem) {
        mPictureSelectedCb.setOnCheckedChangeListener((compoundButton, isChecked) -> {
...
//                    Toast.makeText(mContext, mContext.getString(R.string.picture_num_limit_toast), Toast.LENGTH_SHORT).show();
    ...
    private void checkOriginPictureSelected() {
        mOriginPictureCb.setOnCheckedChangeListener((compoundButton, isChecked) -> {
            if (isChecked) {
