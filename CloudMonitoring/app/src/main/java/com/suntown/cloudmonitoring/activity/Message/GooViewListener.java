...
import com.suntown.cloudmonitoring.weight.BubbleLayout;
import com.suntown.cloudmonitoring.weight.GooView;
...
public class GooViewListener implements OnTouchListener, GooView.OnDisappearListener {
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		if (action == MotionEvent.ACTION_DOWN) {
			...
			mGooView.setStatusBarHeight(ScreenUtils.getStatusBarHeight(v));
	...
	public void onDisappear(PointF mDragCenter) {
		if (mWm != null && mGooView.getParent() != null) {
			...
			bubbleLayout.setCenter((int) mDragCenter.x, (int) mDragCenter.y - ScreenUtils.getStatusBarHeight(mGooView));
