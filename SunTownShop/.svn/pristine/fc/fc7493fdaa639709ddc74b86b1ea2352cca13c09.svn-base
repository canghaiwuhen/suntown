...
public class ModifyInfoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.myaccount_modifyinfo);
	...
	public void showProgress(final boolean show) {
		if (show) {
			mPDialog = new ProgressDialog(ModifyInfoActivity.this);
			// 实例化
	...
	public void selectSex(View v){
		...
		LayoutInflater inflater = (LayoutInflater) ModifyInfoActivity.this
