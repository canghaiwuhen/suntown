 ...
 *
 */
public class PullUpRefreshListView extends ListView implements OnScrollListener {
	...
	public void onScroll(AbsListView arg0, int firstVisiableItem,
		...
		firstItemIndex = firstVisiableItem + visibleItemCount;
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (isRefreshable) {
			...
			case MotionEvent.ACTION_DOWN:
				if (firstItemIndex == getCount() && !isRecored) {
					isRecored = true;
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (!isRecored && firstItemIndex == getCount()) {
				...
				if (state != REFRESHING && isRecored && state != LOADING) {
					...
					if (state == RELEASE_To_REFRESH) {
						headView.setPadding(0, (startY - tempY) / RATIO
