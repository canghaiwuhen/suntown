...
public class FragmentPage4 extends Fragment implements OnClickListener {
	 ...
	 * 购物车广告模块
	 */
	private View viewShopCartAd;
	/**
	 * 购物车广告图片
	 */
	private ImageView ivShopCartAd;
	private ImageView ivShopCartAdClose;
	/**
	 * imageloader相关
	 */
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		viewShopCartAd = view.findViewById(R.id.view_cartad);
		ivShopCartAdClose = (ImageView)view.findViewById(R.id.iv_cartad_close);
		ivShopCartAdClose.setOnClickListener(this);
		ivShopCartAd = (ImageView)view.findViewById(R.id.iv_cartad);
		imageLoader.displayImage("assets://image/shoppingcart-ad.png",ivShopCartAd,options);
		return view;
	}
	...
	public void closeAd(View v){
		viewShopCartAd.setVisibility(View.GONE);
	}
