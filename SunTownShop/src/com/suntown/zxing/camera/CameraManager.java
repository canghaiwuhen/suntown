...
package com.suntown.zxing.camera;
...
public final class CameraManager {
	...
	/**
	 * 控制闪光灯方法,硬件方法似乎已经不支持，改用Camera设置参数 code by ken 2014-12-18
	 * 
	 * @param ison
	 */
	public void setFlashlightState(boolean ison) {
		...
		if (!context.getPackageManager().hasSystemFeature(
			...
			//Toast.makeText(context, "当前设备没有闪光灯", Toast.LENGTH_SHORT).show();
			return;
		}		
		if (camera != null) {
			Parameters parameters = camera.getParameters();
			String value = ison ? Parameters.FLASH_MODE_TORCH
